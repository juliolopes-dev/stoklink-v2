    ...
    <div className="h-screen flex flex-col overflow-hidden p-6">
      ...
      <div className="flex items-center justify-between mb-4 flex-shrink-0">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-semibold text-gray-800">Pedidos DRP</h1>
            <p className="text-sm text-gray-500">Gerenciamento de pedidos de distribuição</p>
          </div>
        </div>
      ...
      {/* Filtros */}
      <div className="bg-white rounded-lg shadow-md border border-gray-200 p-4 mb-4 flex-shrink-0">
        <div className="flex items-center gap-3">
          {/* Busca */}
          ...
          <select
            ...
            className="h-9 px-3 border border-gray-300 rounded-md text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
          >
          ...
          <button
            ...
            className="h-9 px-4 bg-primary-600 hover:bg-primary-700 text-white text-sm font-medium rounded-md transition-colors flex items-center gap-2"
          >
            <FiSearch size={14} />
            Buscar
          </button>
                      ...
                      <tr key={pedido.id} className="border-b border-gray-200 hover:bg-gray-50 transition-colors">
                        <td className="px-3 py-2">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="font-medium text-sm text-gray-900">{pedido.numero_pedido}</span>
                          </div>
                        </td>
                        <td className="px-3 py-2">
                          <span className="text-sm text-gray-900">{pedido.numero_nf_origem || '-'}</span>
                        </td>
                        <td className="px-3 py-2">
                          <div className="flex items-center gap-2">
                            <FiMapPin size={14} className="text-gray-400" />
                            <div>
                              <span className="text-sm font-medium text-gray-900">{pedido.cod_filial_destino}</span>
                              {pedido.nome_filial_destino && (
                                <span className="text-sm text-gray-500"> - {pedido.nome_filial_destino}</span>
                              )}
                            </div>
                          </div>
                        </td>
                        <td className="px-3 py-2">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-sm text-gray-900">{formatDateShort(pedido.data_pedido)}</span>
                          </div>
                        </td>
                        <td className="px-3 py-2">
                          <div className="flex items-center gap-2">
                            <FiUser size={14} className="text-gray-400" />
                            <span className="text-sm text-gray-900">{pedido.usuario || '-'}</span>
                          </div>
                        </td>
                        <td className="px-3 py-2">
                          <span className="text-sm text-gray-900">{pedido.numero_transferencia || '-'}</span>
                        </td>
                        <td className="px-3 py-2 text-center">
                          <span className="text-sm font-medium text-gray-900">{pedido.total_itens || 0}</span>
                        </td>
                        <td className="px-3 py-2 text-center">
                        ...
                        <td className="px-3 py-2 text-right">
                          <Link
                            ...
                            className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-gray-700 border border-gray-300 hover:bg-gray-50 rounded-md transition-colors"
                          >
                            <FiEye size={14} />
                            Detalhes
                          </Link>
