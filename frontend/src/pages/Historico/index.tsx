        ...
        <div className="flex-1 overflow-y-auto">
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center h-64 text-gray-500">
              ...
              <p className="text-sm mt-2">O histórico aparecerá quando houver alterações no sistema</p>
            </div>
          ) : (
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-1">
                          <span className={`px-2 py-1 rounded-full text-xs font-medium ${acaoInfo.color}`}>
                            {acaoInfo.label}
                          </span>
                        ...
                        {changes && changes.length > 0 && (
                          <div className="mt-2 bg-gray-50 rounded-lg p-3 text-sm">
                            <p className="text-xs font-medium text-gray-500 mb-2">Alterações:</p>
